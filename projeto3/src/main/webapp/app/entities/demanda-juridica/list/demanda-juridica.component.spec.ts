...
describe('Component Tests', () => {
  describe('DemandaJuridica Management Component', () => {
    let comp: DemandaJuridicaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DemandaJuridicaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.demandaJuridicas?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
